...
MetroRemoveStops = {
	vec4(-869.39, -2296.33, -11.73, 72.16),
	vec4(-871.64, -2301.85, -11.73, 69.89),
	vec4(-873.44, -2306.99, -11.73, 67.05),
	vec4(-875.5, -2312.68, -11.73, 69.8),

	vec4(-897.43, -2342.32, -11.73, 250.01),
	vec4(-895.34, -2336.66, -11.73, 250.31),
	vec4(-893.48, -2331.55, -11.73, 249.47),
	vec4(-891.57, -2325.9, -11.73, 249.31),

	vec4(-1101.23, -2728.62, -7.41, 227.55),
	vec4(-1097.36, -2724.09, -7.41, 230.58),
	vec4(-1093.77, -2719.95, -7.41, 231.85),
	vec4(-1089.99, -2715.42, -7.41, 229.77),

	vec4(-1070.26, -2708.47, -7.41, 45.45),
	vec4(-1074.27, -2713.15, -7.41, 50.39),
	vec4(-1077.72, -2717.19, -7.41, 49.67),
	vec4(-1081.55, -2721.83, -7.41, 51.69),


	vec4(263.36, -1200.87, 38.9, 178.04),
	vec4(-538.64, -1284.41, 26.9, 66.29),
	-----
